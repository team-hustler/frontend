...
var jsonInterface = require('./donation.json') 
var web3 = new Web3(Web3.givenProvider ||new Web3.providers.HttpProvider('https://rpc-mumbai.maticvigil.com'));
const deployer = "0xb3255a0173A7dBeEA62742ee0aC135aBDb82e39b"
const mnemonic = "df1e583a43f0e2c78665fcc2cbaf25864e0013d2d8ca42cffc574ad8fb87d905";
  let  main = async () => {
  const  accounts = await  web3.eth.getAccounts()
  var Contract = require('web3-eth-contract');
  Contract.setProvider('https://rpc-mumbai.maticvigil.com');
  var contract = new Contract(jsonInterface.abi, '0xD40D1Ec7CFcAA2929eC9aCF1744A3246B8bD2C7a');
...
let student = [
  ...
  //     });
   ...
   sponser = [
    { name : "0x872c62aD2876B3aCF23f0E1D18279A91cC01e274", studentID :  5, amount :  56888 } , 
    { name : "0xbEe389596E36ba466218bd4a45a5A8fFD3C43174", studentID :  1, amount :  6000 } , 
    { name : "0x2C610cc9483AbC46c50Fe36414F6183591d4fd3e", studentID :  3, amount :  3000 } , 
    { name : "0x872c62aD2876B3aCF23f0E1D18279A91cC01e274", studentID :  2, amount :  7000 } , 
